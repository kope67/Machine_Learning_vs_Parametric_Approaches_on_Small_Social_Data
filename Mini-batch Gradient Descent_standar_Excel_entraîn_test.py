...
def train_mini_batchGD(X, y, learning_rate=0.001, n_iter=100, batch_size=32):
    m, n = X.shape
    W, b = initialize(n)
    losses = []
...
def main():
    ...
    # === 5. Entraînement ===
    W, b, losses = train_mini_batchGD(X_train, y_train, learning_rate=0.001, n_iter=100, batch_size=32)
