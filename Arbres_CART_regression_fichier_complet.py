...
if __name__ == "__main__":
    ...
    # --- Régression ---
    csv_path_regr = r"data/caractéristique numérique_gestionnaires_fusion.csv"
    feature_col_regr = ["Heure_travail_semaine"]    # à adapter
    target_col_regr = "Nombre_réunions_hebdo"     # à adapter
